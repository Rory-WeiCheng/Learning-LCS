...
gamma = 1e-2
# epsilon represent the weight put on LCP violation part (weight is 1/epsilon) # 2e-5 before
epsilon = 2e-5
...
vn_learning_rate = 5e-3 # 4e-3 for old gait, 5e-3 for new gait before issue fixed
